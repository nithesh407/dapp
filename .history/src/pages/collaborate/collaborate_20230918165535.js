        ...
        >
          ...
          <Option value="jack" label="Jack">
            <div style={{ display: 'flex', alignItems: 'center' }}>
              <img src="https://xsgames.co/randomusers/avatar.php?g=pixel" alt="Jack Avatar" style={{ width: '20px', height: '20px', borderRadius: '50%', marginRight: '10px' }} />
              Jack
            </div>
          </Option>
          ...
          <Option value="tom" label="Tom">
            <div style={{ display: 'flex', alignItems: 'center' }}>
              <img src={avatarImages.scr} alt="Tom Avatar" style={{ width: '20px', height: '20px', borderRadius: '50%', marginRight: '10px' }} />
              Tom
            </div>
          </Option>
        </Select>
