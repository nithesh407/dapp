...
import avatarImages from "../../assets/profile.png"
        ...
        >
          ...
          <Option value="jack" label="Jack">
            <div style={{ display: 'flex', alignItems: 'center' }}>
              <img src={avatarImages} alt="Jack Avatar" style={{ width: '20px', height: '20px', borderRadius: '50%', marginRight: '10px' }} />
              Jack
            </div>
          </Option>
          <Option value="lucy" label="Lucy">
            <div style={{ display: 'flex', alignItems: 'center' }}>
              <img src={avatarImages} alt="Lucy Avatar" style={{ width: '20px', height: '20px', borderRadius: '50%', marginRight: '10px' }} />
              Lucy
            </div>
          </Option>
          <Option value="tom" label="Tom">
            <div style={{ display: 'flex', alignItems: 'center' }}>
              <img src={avatarImages} alt="Tom Avatar" style={{ width: '20px', height: '20px', borderRadius: '50%', marginRight: '10px' }} />
              Tom
            </div>
          </Option>
        </Select>
